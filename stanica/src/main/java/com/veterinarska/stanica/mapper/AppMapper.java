...
public class AppMapper {
    ...
    public static MedicinskiZapisDTO toDTO(MedicinskiZapis m) {
        ...
        String vrsta = (l != null && l.getVrsta() != null && !l.getVrsta().trim().isEmpty())
                ? l.getVrsta().trim() : null;
    ...
    public static ZahtevZaPrijateljstvoDTO toDTO(ZahtevZaPrijateljstvo z) {
        ...
        if (pos != null) {
            dto.setPosiljalacId(pos.getId());
            dto.setPosiljalacEmail(pos.getEmail());
            dto.setPosiljalacIme(pos.getIme());
            dto.setPosiljalacPrezime(pos.getPrezime());
        }

        if (pri != null) {
            dto.setPrimalacId(pri.getId());
            dto.setPrimalacEmail(pri.getEmail());
        }

        dto.setStatus(z.getStatus() != null ? z.getStatus().name() : null);
        dto.setKreiran(z.getKreiran()); // sada je LocalDateTime i u entitetu i u DTO-u
