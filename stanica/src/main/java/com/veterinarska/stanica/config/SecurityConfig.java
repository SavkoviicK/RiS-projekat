        ...
        http
            ...
            .authorizeHttpRequests(auth -> auth
                ...
                .requestMatchers("/", "/home", "/ljubimci", "/pregledi", "/poruke",
                                 "/izvestaji", "/prijava", "/login", "/registracija", "/karton",
                ...
                // Medicinski zapisi
                .requestMatchers(HttpMethod.GET,  "/api/medicinski-zapisi/moji-ljubimci-za-izvestaj").hasAnyRole("VETERINAR","ADMIN")
                .requestMatchers(HttpMethod.GET,  "/api/medicinski-zapisi/moji-izvestaji").hasAnyRole("VLASNIK","ADMIN")
                .requestMatchers(HttpMethod.POST, "/api/medicinski-zapisi").hasAnyRole("VETERINAR","ADMIN")
                // sve ostalo iz /api/medicinski-zapisi/** dostupno veterinaru i adminu
